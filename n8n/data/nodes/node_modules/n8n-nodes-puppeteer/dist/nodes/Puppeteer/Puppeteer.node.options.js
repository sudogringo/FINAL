...
function isRunningInContainer() {
    try {
        ...
        if (process.platform === "linux") {
            try {
                const cgroupContent = (0, node_fs_1.readFileSync)("/proc/1/cgroup", "utf8");
        ...
        console.log("Puppeteer node: Container detection failed:", error.message);
        return false;
    }
}
const buildProperties = () => {
    const properties = [
        ...
        },
        {
            ...
            description: "JavaScript code to execute with Puppeteer. You have access to the $browser and $page objects, which represent the Puppeteer browser and page. When used as an AI agent tool, AI can dynamically generate this script using $fromAI(), or you can write a reusable script that processes input from the Query parameter below.",
        ...
        },
        {
            ...
            type: "string",
            default: "",
            description: "Input query for AI agents. When this node is used as a tool by an AI agent, the agent's query/instruction will be passed here. Access this value in your custom script using $input.query. You can use $fromAI() when configuring this as a tool.",
            displayOptions: {
                show: {
                    operation: ["runCustomScript"],
                },
        ...
        ...(isRunningInContainer()
            ? [
                {
                    displayName: "ℹ️ Container environment detected. Chrome launch arguments (--no-sandbox, etc.) are automatically added. This can be toggled in Options > Add Container Arguments.",
            ...
            : []),
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    required: false,
                    default: "",
                    description: "The WebSocket URL of the browser to connect to. When configured, puppeteer will skip the browser launch and connect to the browser instance. Can also be set globally via environment variables: PUPPETEER_BROWSER_WS_ENDPOINT or PUPPETEER_WS_ENDPOINT.",
                },
                {
                    ...
                    options: [
                        {
                            ...
                            value: "cdp",
                            description: "Default protocol for Chrome/Chromium browsers",
                        },
                        {
                            name: "WebDriver BiDi",
                            value: "webDriverBiDi",
                            description: "Protocol for Firefox and cross-browser automation",
                        },
                    ],
                    default: "cdp",
                    description: "The protocol to use when connecting to the browser. Use WebDriver BiDi for Firefox support. Can also be set globally via environment variable: PUPPETEER_PROTOCOL.",
                    required: false,
                },
                {
                ...
                },
                {
                    ...
                    type: "boolean",
                    default: false,
                    description: "When enabled, any files downloaded during script execution (via clicks, direct downloads, etc.) will be automatically captured and returned as binary data in the node output. Useful for downloading PDFs, images, or other files triggered by user interactions.",
                    required: false,
                },
                {
                    ...
                    type: "boolean",
                    default: true,
                    description: "Container environments are auto-detected and optimized automatically. When enabled (default), recommended Chrome arguments (--no-sandbox, --disable-setuid-sandbox, --disable-dev-shm-usage, --disable-gpu) are added when running in Docker/Kubernetes. Disable only if you experience launch issues.",
                    required: false,
                },
            ],
        },
